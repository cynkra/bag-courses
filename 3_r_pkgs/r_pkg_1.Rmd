...
Summary:
- R package stores functions (and/or data)
...
- Have a look at which files/directories were created.
...
Use `{roxygen2}` for automating documentation process as much as possible.

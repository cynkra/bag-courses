...
The second argument to `setMethod()` is called `signature` and can multiple arguments, which turns method dispatch into a complicated issue.
...
In general it is possible though to keep these cases rare.
...
This OOP comes with the package {R6}.

...
using `?geom_line` we find which aesthetics are available, but to summarize the main ones are:
...
Using the economics dataset and the knowledge from the previous slides, draw a plot using `geom_line` and different aesthetics mapped to variables.

---

# `geom_bar()`

using `?geom_bar` we find which aesthetics are available, but to summarize the main ones are:
...
Using the diamonds dataset and the knowledge from the previous slides, draw a barplot using different aesthetics mapped to variables.

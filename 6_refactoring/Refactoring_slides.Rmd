...
nested projectes it's fine to use relative paths without `here::here()` in your R scripts.
...
Let's apply those ideas on your code!
...
Let's apply what we've seen so far!  
...
my_script_fun <- function(input1, input2, ...) {
  # copy script there
  output 
  # OR if several outputs: list(output1 = output1, output2 = output2)
}
...
detect problematic summarize calls. Let's try it!
